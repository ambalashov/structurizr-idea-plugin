...
public class StructurizrComponentViewExprImpl extends ASTWrapperPsiElement implements StructurizrComponentViewExpr {

  public StructurizrComponentViewExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrVisitor visitor) {
    visitor.visitComponentViewExpr(this);
  }
