...
import io.github.ambalashov.sturcturizr.psi.StructurizrPropKey;
...
public class StructurizrPropKeyImpl extends ASTWrapperPsiElement implements StructurizrPropKey {

  public StructurizrPropKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrVisitor visitor) {
    visitor.visitPropKey(this);
  }
