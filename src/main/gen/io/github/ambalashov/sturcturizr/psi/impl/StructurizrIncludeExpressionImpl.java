...
public class StructurizrIncludeExpressionImpl extends ASTWrapperPsiElement implements StructurizrIncludeExpression {

  public StructurizrIncludeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrVisitor visitor) {
    visitor.visitIncludeExpression(this);
  }
