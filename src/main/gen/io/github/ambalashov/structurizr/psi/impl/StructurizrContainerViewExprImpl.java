...
public class StructurizrContainerViewExprImpl extends ASTWrapperPsiElement implements StructurizrContainerViewExpr {

  public StructurizrContainerViewExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StructurizrVisitor visitor) {
    visitor.visitContainerViewExpr(this);
  }
