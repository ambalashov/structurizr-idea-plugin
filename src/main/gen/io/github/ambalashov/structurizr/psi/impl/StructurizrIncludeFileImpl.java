...
public class StructurizrIncludeFileImpl extends StructurizrIncludeFileMixin implements StructurizrIncludeFile {

  public StructurizrIncludeFileImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getFile() {
    return findNotNullChildByType(StructurizrTypes.FILE);
  }
